...
@section('content')
    <section class="content-header">
        <h1>
            Chỉnh sủa thông tin bài viết <a href="{{route('admin.article.index')}}" class="btn btn-success pull-right"><i class="fa fa-list"></i> Danh Sách</a>
        </h1>
    </section>
                    ...
                    <form role="form" action="{{ route('admin.article.update',['id'=>$data->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <img src="{{asset($data->new_image)}}" width="250" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Sơ lược bài viết</label>
                                <input type="text" class="form-control" id="summary" name="summary" value="{{ $data->summary }}" placeholder="chi tiết bài viết">
                            </div>
                            <div class="form-group">
